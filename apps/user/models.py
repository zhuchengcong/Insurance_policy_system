...
class User(SoftDeleteModel, BaseModel):
    ...
    mobile = models.CharField(max_length=11, default='', null=True, blank=True, verbose_name='用户手机号')
    email = models.EmailField(default='', null=True, blank=True, verbose_name='用户邮箱')
    real_name = models.CharField(max_length=16, default='', null=True, blank=True, verbose_name='真实姓名')
    id_num = models.CharField(max_length=18, default='', null=True, blank=True, verbose_name='身份证号')
    nick_name = models.CharField(max_length=32, default='', null=True, blank=True, verbose_name='昵称')
    region = models.CharField(max_length=255, default='', null=True, blank=True, verbose_name='地区')
    avatar_url = models.CharField(max_length=255, default='', null=True, blank=True, verbose_name='头像')
    open_id = models.CharField(max_length=255, default='', null=True, blank=True, verbose_name='微信openid')
    union_id = models.CharField(max_length=255, default='', null=True, blank=True, verbose_name='微信unionid')
    gender = models.IntegerField(choices=((0, '未知'), (1, '男'), (2, '女')), default=0, verbose_name='性别', null=True,
                                 blank=True)
    ...
    group = models.ForeignKey(Group, on_delete=models.PROTECT, verbose_name='用户组', null=True, blank=True)
    # 组权分离后 当有权限时必定为管理员类型用户，否则为普通用户
    auth = models.ForeignKey(Auth, on_delete=models.PROTECT, null=True, blank=True,
