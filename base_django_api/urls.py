...
router.register(r'FeeField', FeeFieldViewset, basename='费率字段管理')
router.register(r'ChannelMatch', ChannelMatchViewset, basename='渠道匹配管理')
router.register(r'Settlements', SettlementsViewset, basename='结算管理')
router.register(r'Remit', RemitViewset, basename='结算单打款明细管理')
